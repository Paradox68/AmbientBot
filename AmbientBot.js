            ...
            if (ambient.settings.welcome && greet) {
                welcomeback ?
                    setTimeout(function (user) {
                        //API.sendChat(subChat('/me Welcome back to The Bass Music Network Room, @' + user.username + '.'));
                    }, 1 * 1000, user)
                    :
                    setTimeout(function (user) {
                       // API.sendChat(subChat('/me Welcome to TheThe Bass Music Network Room, @' + user.username + '. Enjoy your stay.'));
                    }, 1 * 1000, user);
